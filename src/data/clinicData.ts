...
export const REVIEWS_DATA: ReviewItem[] = [
  {
    ...
    avatarInitial: "N",
    rating: 5,
    treatmentBM: "Rawatan Braces & Konsultasi Pergigian",
    treatmentEN: "Scaling & Damon Braces Treatment",
    textBM: "Saya rasa sangat selesa sebaik sahaja melangkah masuk ke klinik ini dengan layanan mesra dari kakitangan kaunter. Dr Adlan memberikan penerangan yang sangat terperinci sehingga saya benar-benar faham tentang keadaan gigi saya.",
    textEN: "I felt pure comfort when entering this clinic with the warm welcoming feeling from the front desk person. Dr Adlan gave an in depth explanation that made me fully understand.",
    date: "Local Guide · Google Review",
    verified: true,
    category: "braces"
  },
  {
    ...
    avatarInitial: "H",
    rating: 5,
    treatmentBM: "Rawatan Gigi & Pembedahan Gigi Bongsu",
    treatmentEN: "Wisdom Tooth Surgery & General Care",
    textBM: "Rawatan oleh Dr Noor Syafizah yang penuh dengan kelembutan dan perhatian membuatkan saya yakin berada di tangan yang betul. Perkhidmatan yang cemerlang!",
    textEN: "Treatment by Dr Noor Syafizah filled with tender and care made me confident that I was under good hands of her. Excellent service!",
  ...
  },
  {
    ...
    avatarInitial: "E",
    rating: 5,
    treatmentBM: "Scaling, Polishing & Penjagaan Umum",
    treatmentEN: "Scaling, Polishing & General Care",
    textBM: "Kakitangan yang sangat mesra, persekitaran klinik yang bersih dan selesa serta perkhidmatan terbaik dari Dr Adlan. Sangat disyorkan untuk semua di Bangi.",
    textEN: "Friendly staff, nice environment and good service by Dr Adlan. Highly recommended to everyone in Bangi.",
    date: "Local Guide · Google Review",
    verified: true,
    category: "scaling"
  },
  {
    id: "r4",
    name: "Danialnaeem Emirzan",
    avatarInitial: "D",
    rating: 5,
    treatmentBM: "Rawatan Braces & Scaling Gigi",
    treatmentEN: "Braces & Scaling Treatment",
    textBM: "Servis sangat pantas dan profesional. Penerangan doktor sangat jelas dan rawatan diselesaikan dengan selesa. Terbaik!",
    textEN: "Very professional clinic. They explained everything clearly and finished the treatment with zero discomfort. Highly recommended in Bangi.",
    date: "Verified Google Review",
    verified: true,
    category: "braces"
  },
  {
    ...
    avatarInitial: "A",
    rating: 5,
    treatmentBM: "Pemeriksaan Gigi & Rawatan Isian Komposit",
    treatmentEN: "Composite Filling & Consultation",
    textBM: "Alhamdulillah, servis sangat bagus dan berkualiti. Sangat cepat selesaikan rawatan dan doktor peramah. Puas hati sangat!",
    textEN: "Alhamdulillah, service is very good and high quality. Treatment was completed quickly and the dentist was friendly. Very satisfied!",
    date: "Verified Google Review",
    verified: true,
    category: "general"
  },
  {
    ...
    avatarInitial: "M",
    rating: 5,
    treatmentBM: "Pemeriksaan Gigi & Implan Pergigian",
    treatmentEN: "Dental Implant & Consultation",
    textBM: "Klinik pergigian yang sangat profesional di Bangi. Doktor dan kakitangan terangkan prosedur dengan jelas dan hasil rawatan amat memuaskan.",
    textEN: "Very professional dental clinic in Bangi. The doctors and staff explain every procedure clearly and the treatment results are top quality.",
    date: "Verified Google Review",
    verified: true,
    category: "implant"
  }
