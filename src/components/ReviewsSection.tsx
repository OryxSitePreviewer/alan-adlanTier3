        ...
        <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-6 mb-10">
          ...
          <div className="flex flex-wrap items-center gap-3">
            <div className="inline-flex items-center gap-3 bg-white px-5 py-3 rounded-2xl shadow-sm border border-slate-200">
              <div className="w-9 h-9 rounded-full bg-slate-900 flex items-center justify-center text-amber-400 font-bold text-sm shadow-xs border border-amber-500/40">
                <svg className="w-4 h-4" viewBox="0 0 24 24">
                  ...
                  <path fill="#FBBC05" d="M5.6 14.8c-.2-.7-.4-1.5-.4-2.3s.2-1.6.4-2.3L1.9 7.3C.7 9.7 0 12.3 0 15s.7 5.3 1.9 7.7l3.7-2.9c-.8-.7-1.4-1.8-1.8-3z" />
            ...
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="inline-flex items-center gap-2 bg-slate-900 hover:bg-slate-800 text-white text-xs font-bold px-5 py-3.5 rounded-2xl transition shadow-sm"
            >
              <span>Read all 330+ reviews on Google</span>
