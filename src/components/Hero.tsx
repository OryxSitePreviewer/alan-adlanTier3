            ...
            <div className="bg-white/95 backdrop-blur-md p-6 sm:p-8 rounded-2xl border border-slate-200 shadow-xl space-y-6">
              ...
              <div className="space-y-3">
                <div className="p-3.5 rounded-xl bg-[#FAF8F5] border border-slate-200 flex items-center justify-between hover:border-[#B8860B]/70 transition group">
                  <div>
                    <h4 className="font-bold text-slate-900 text-sm">Orthodontics (Braces)</h4>
                    <p className="text-xs text-slate-600 font-normal">
                      Low deposit & monthly installments
                    </p>
                  </div>
                  <a
                    href={`https://wa.me/${CLINIC_INFO.whatsappNumberDigits}?text=${encodeURIComponent('Hi, I would like to inquire about Braces packages.')}`}
                    target="_blank"
                    rel="noreferrer"
                ...
                <div className="p-3.5 rounded-xl bg-[#FAF8F5] border border-slate-200 flex items-center justify-between hover:border-[#B8860B]/70 transition group">
                  <div>
                    <h4 className="font-bold text-slate-900 text-sm">Teeth Whitening</h4>
                    <p className="text-xs text-slate-600 font-normal">
                      In-office 45-60 mins session
                    </p>
                  </div>
                  <a
                    href={`https://wa.me/${CLINIC_INFO.whatsappNumberDigits}?text=${encodeURIComponent('Hi, I would like to inquire about Teeth Whitening.')}`}
                    target="_blank"
                    rel="noreferrer"
                    className="p-2 rounded-lg bg-white border border-slate-300 text-[#B8860B] group-hover:bg-[#B8860B] group-hover:text-white transition shadow-xs"
                  >
                ...
                <div className="p-3.5 rounded-xl bg-[#FAF8F5] border border-slate-200 flex items-center justify-between hover:border-[#B8860B]/70 transition group">
                  <div>
                    <h4 className="font-bold text-slate-900 text-sm">Scaling & Polishing (Dental Cleaning)</h4>
                    <p className="text-xs text-slate-600 font-normal">
                      Deep plaque & tartar removal
                    </p>
                  </div>
                  <a
                    href={`https://wa.me/${CLINIC_INFO.whatsappNumberDigits}?text=${encodeURIComponent('Hi, I would like to book a Scaling & Polishing session.')}`}
                    target="_blank"
                    rel="noreferrer"
                    className="p-2 rounded-lg bg-white border border-slate-300 text-[#B8860B] group-hover:bg-[#B8860B] group-hover:text-white transition shadow-xs"
                  >
